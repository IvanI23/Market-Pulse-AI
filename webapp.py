...
def index():
    if request.method == 'POST':
        ...
        if user_id:
            ...
            if email_sent:
                message = f'Successfully signed up! Welcome email sent. You will receive alerts for your selected tickers.'
            else:
                message = f'Successfully signed up! You will receive alerts for your selected tickers. (Welcome email failed to send - please check your email settings)'
